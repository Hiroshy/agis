                ...
                <div class="align-items-center d-flex h-100">
                    <div class="card-body">
                        ...
                        <form action="#">
                            ...
                            <div class="form-group">
                                <a href="//<?=$app['web_url_secure'].$app['base_url_admin']?>module/authentication/recovery-password" class="text-muted float-right"><small>Forgot your password?</small></a>
                        ...
                        <footer class="footer footer-alt">
                            <p class="text-muted">Don't have an account? <a href="//<?=$app['web_url_secure'].$app['base_url_admin']?>module/authentication/sign-up" class="text-muted ml-1"><b>Sign Up</b></a></p>
                        </footer>
