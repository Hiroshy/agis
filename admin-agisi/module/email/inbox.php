                                                ...
                                                <ul class="email-list">
                                                    <li class="unread">
                                                        <div class="email-sender-info">
                                                            ...
                                                            <a href="<?= $app['base_url_admin']; ?>module/email/read" class="email-title">Lucas Kriebel (via Twitter)</a>
                                                        </div>
                                                        <div class="email-content">
                                                            <a href="<?= $app['base_url_admin']; ?>module/email/read"  class="email-subject">Lucas Kriebel (@LucasKriebel) has sent
