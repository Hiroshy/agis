                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div data-simplebar style="max-height: 550px;">
                                                            ...
                                                            <a href="javascript:void(0);" class="text-body">
                                                                <div class="media mt-1 p-2">
                                                                    <img src="../../assets/images/users/avatar-10.jpg" class="mr-2 rounded-circle" height="48" alt="Rhonda D" />
                                                                    <div class="media-body">
                                                                        <h5 class="mt-0 mb-0 font-14">
                                                            ...
                                                            <a href="javascript:void(0);" class="text-body">
                                                                <div class="media mt-1 p-2">
                                                                    <img src="../../assets/images/users/avatar-3.jpg" class="mr-2 rounded-circle" height="48" alt="Michael H" />
                                                                    <div class="media-body">
                                                                        <h5 class="mt-0 mb-0 font-14">
                                                            ...
                                                            <a href="javascript:void(0);" class="text-body">
                                                                <div class="media mt-1 p-2">
                                                                    <img src="../../assets/images/users/avatar-6.jpg" class="mr-2 rounded-circle" height="48" alt="Thomas R" />
                                                                    <div class="media-body">
                                                                        <h5 class="mt-0 mb-0 font-14">
                                                                            <span class="float-right text-muted font-12">Tue</span>
                                                                            Thomas R
                                                            ...
                                                            <a href="javascript:void(0);" class="text-body">
                                                                <div class="media mt-1 p-2">
                                                                    <img src="../../assets/images/users/avatar-8.jpg" class="mr-2 rounded-circle" height="48" alt="Thomas J" />
                                                                    <div class="media-body">
                                                                        <h5 class="mt-0 mb-0 font-14">
                                                                            <span class="float-right text-muted font-12">Tue</span>
                                                                            Thomas J
                                                            ...
                                                            <a href="javascript:void(0);" class="text-body">
                                                                <div class="media mt-1 p-2">
                                                                    <img src="../../assets/images/users/avatar-1.jpg" class="mr-2 rounded-circle" height="48" alt="Ricky J" />
                                                                    <div class="media-body">
                                                                        <h5 class="mt-0 mb-0 font-14">
                                                                            <span class="float-right text-muted font-12">Mon</span>
                                                                            Ricky J
                                                                        </h5>
                                                                        <p class="mt-1 mb-0 text-muted font-14">
