<?php
    class Slider extends DB { 
        ...
        public function insertar($data) {
            ...
            try {
                $query="INSERT INTO {$this->table} (title,url,image,image_mobile) VALUES ('$data[title]','$data[url]','$data[image]','$data[image_mobile]') "; 
                #Prepare
        ...
        function actualizar($data) {
            $conexion = parent::conectar();
            try {
                $query="UPDATE {$this->table} SET title='$data[title]',url='$data[url]'";
