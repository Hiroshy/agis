<?php 
    ...
    /** MODEL */
    include_once("../Model/SlidersPromo.php");
    $sliders = new SliderPromo();
    ...
    foreach($sliders as $product):
        ...
        $resultProduct['parraf']=$product['parraf'];
                    ...
                    <div class="container-fluid px-0">
                        <div class="form-group pt-4 pl-3 d-flex">
                            ...
                            <div class="col-lg-6 mx-auto px-0">
                                <form action="/admin-agisi/module/design/elements/slidersPromo/edit/<?= $_GET['id'];?>" class="p-3" method="post" class="dropzone" id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="product">Parrafo</label>
                                        <input type="text" class="form-control" id="parraf" name="parraf" value="<?=$resultProduct['parraf']?>">
                                    </div>
