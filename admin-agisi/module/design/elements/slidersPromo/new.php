                            ...
                            <div class="col-lg-6 mx-auto px-0">
                                <form action="<?= $_SERVER['PHP_SELF'] ?>" class="p-3" method="post" class="dropzone" id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="parraf" name="parraf">
                                    </div>
                                ...
                                <?php
                                    if ($_POST) {
                                        ...
                                        for ($i=0; $i< count($_FILES["slide_item"]["tmp_name"]); $i++){
                                        ...
                                        for ($i=0; $i< count($_FILES["slide_item_mobile"]["tmp_name"]); $i++){
                                        ...
                                        $data=[
                                            ...
                                            "parraf"=>$_POST['parraf'],
                                            "url"=>$_POST['url'],
                                            "image"=>$app['business'].'_'.$_FILES['slide_item']['name'],
                                            "image_mobile"=>$app['business'].'_'.$_FILES['slide_item_mobile']['name']
                                        ];

                                        echo $sliders->insertar($data);
                                    }
                                ?>
                            </div>
                        </div>
