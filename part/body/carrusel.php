      ...
      <div id="controles" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="/assets/media/carousel/bomberos_agis.jpg" srcset="/assets/media/carousel/bomberos_agis.jpg 1024w,/assets/media/carousel/bomberos_agis_mobil.jpg 900w" class="img-fluid w-100" alt="Bomberos de AGIS">
            <div class="carousel-caption d-none center_content_carousel">
              ...
              <div class="form-group mt-4 d-sm-none">
                <button class="btn-info-agis mx-0">
          ...
          <div class="carousel-item">
            <img src="/assets/media/carousel/bomberos_agis.jpg" srcset="/assets/media/carousel/bomberos_agis.jpg 1024w,/assets/media/carousel/bomberos_agis_mobil.jpg 800w" class="img-fluid w-100" alt="Bomberos de AGIS">
            <div class="carousel-caption d-none center_content_carousel">
